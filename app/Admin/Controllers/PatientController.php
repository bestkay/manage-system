...
class PatientController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->column('media.title', __('渠道'))->hide();
        ...
        $grid->column('author.name', __('录入人员'))->hide();
        $grid->column('receive.title', __('接诊主任'))->hide();
        $grid->column('cure.title', __('主治医生'))->hide();
        $grid->column('come_time', __('预约时间'))->sortable();
        $grid->column('edit_log', __('修改记录'))->hide();
        $grid->column('memo', __('备注'))->hide();
        $grid->column('created_at', __('添加时间'))->sortable()->hide();
